        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            <p className="text-sm leading-6 text-gray-300">
              High-quality 3D printed functional items, art pieces, and custom orders with a futuristic design aesthetic.
            </p>
        ...
        <div className="mt-16 border-t border-gray-800 pt-8 sm:mt-20 lg:mt-24">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            <div className="space-y-4 xl:col-span-1">
              ...
              <p className="text-sm leading-6 text-gray-300">
                Get the latest updates on new products, sales, and 3D printing news.
              </p>
              <form onSubmit={handleSubmit} className="mt-2 flex max-w-md gap-x-4">
                ...
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="w-full rounded-md border-0 bg-gray-800 text-white py-2 pl-10 pr-3 text-sm ring-1 ring-inset ring-gray-700 placeholder:text-gray-400 focus:ring-2 focus:ring-blue-500"
                    placeholder="Enter your email"
                  />
                </div>
                <button
                  type="submit"
                  className="flex-none rounded-md bg-blue-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500"
                >
                  Subscribe
                </button>
              </form>
            ...
            <div className="mt-8 xl:col-span-2 xl:mt-0">
              <div className="md:flex md:items-center md:justify-between">
                <p className="text-sm leading-6 text-gray-300">
                  &copy; {new Date().getFullYear()} NSynthic. All rights reserved.
                </p>
